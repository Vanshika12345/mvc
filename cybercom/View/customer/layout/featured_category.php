<?php $categories = $this->getCategoryImages()->getData();?>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="popular">
                  <ul class="aa-product-catg aa-popular-slider">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="#"><img src="<?php echo $this->baseUrl('Images/Category/').$category->image;?>" alt=""></a>
                        <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                         <figcaption>
                          <h4 class="aa-product-title"><a href="#"><?= $category->name;?></a></h4>
