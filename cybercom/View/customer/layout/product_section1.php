 <?php $products = $this->getProductImages(); ?>
  <!-- Products section -->
              ...
              <div class="aa-product-inner">
                <!-- start product navigation -->
                  <ul class="nav nav-tabs aa-products-tab">
                    <li class="active"><a href="#bedroom" data-toggle="tab">Bedroom</a></li>
                    <li><a href="#dining" data-toggle="tab">Women</a></li>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="bedroom">
