  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link text-white" onclick ="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','admin_shippingmethod')?>').resetParam().load();" href="javascript:void(0);">&nbsp;&nbsp;Shipping Methods</a>
      </li>

      <li class="nav-item">
        <a class="nav-link text-white" onclick ="object.setUrl('<?php echo $this->getUrl()->getUrl('grid','admin_paymentmethod')?>').resetParam().load();" href="javascript:void(0);">&nbsp;&nbsp;Payment Methods</a>
      </li>
      <li class="nav-item">
