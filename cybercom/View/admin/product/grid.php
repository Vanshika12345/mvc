				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
						 	...
						 	<td>
						 		<button class='btn-warning'onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('edit','admin_product',['productId'=>$value->productId]); ?>').resetParam().load()"><i class='far fa-edit'></i></button>&nbsp;&nbsp;
