...
<table class="table" id="existingTable">
	...
	<tfoot>
		<td><button type="button" class="btn btn-success" id="addNewRow">Add</button>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-success" onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('save','admin_attribute_option');?>').resetParam().setParams($('#editForm').serializeArray()).load();">Update</button></td>
		<td></td><td></td>
	</tfoot>
